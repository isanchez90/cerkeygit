...
include 'Internal/DataArrayTrait.php';
include 'Internal/LocalFileOpenTrait.php';
include 'Internal/SatTypeEnum.php';
include 'PemExtractor.php';
include 'PrivateKey.php';
include 'PublicKey.php';
